...
set key left
set title "Comparaisons des performances selon les versions et les compilateurs (avec ICX et 10000 corps)"
...
plot '10000P_icx.dat' using 2:xticlabels(1) ti "-O0", '' using 3:xticlabels(1) ti "-O2", '' using 4:xticlabels(1) ti "-Ofast"
