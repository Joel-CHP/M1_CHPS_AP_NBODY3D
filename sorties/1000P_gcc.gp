...
set key left
set title "Comparaisons des performances selon les versions et les compilateurs (avec GCC et 1000 corps)"
...
plot '1000P_gcc.dat' using 2:xticlabels(1) ti "-O0", '' using 3:xticlabels(1) ti "-O2", '' using 4:xticlabels(1) ti "-Ofast"
